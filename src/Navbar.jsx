...
export default function Navbar() {
  ...
  return (
    <header className={`fixed top-0 inset-x-0 z-50 transition-all ${scrolled ? 'backdrop-blur-xl bg-white/60 dark:bg-neutral-900/50 border-b border-black/5' : 'bg-transparent'}`}>
        ...
        <div className="h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-2">
            ...
            <a
              ...
              className="ml-2 px-4 py-2 rounded-full text-sm font-semibold bg-black text-white hover:bg-neutral-800 dark:bg-white dark:text-black dark:hover:bg-neutral-200 transition shadow"
            >
              Get in touch
            </a>
          </nav>

          <button className="md:hidden inline-flex h-10 w-10 items-center justify-center rounded-xl hover:bg-black/5 dark:hover:bg-white/10 transition" onClick={() => setOpen(!open)} aria-label="Toggle menu">
